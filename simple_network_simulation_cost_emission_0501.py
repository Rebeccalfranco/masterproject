...
def solve_network(n, renewable_carriers,co2_emissions, *args, **kwargs):
    ...
    co2_emissions_t=np.nansum((n.snapshot_weightings.generators @ n.generators_t.p) / n.generators.efficiency * n.generators.carrier.map(n.carriers.co2_emissions))
...
if __name__=="__main__":
    ...
    list_renewable_carriers =  ['Renewable','Solar', 'solar','offwind-ac', 'Wind', 'onwind', 'biomass','ror', 'geothermal','hydro', 'offwind-ac', 'offwind-dc', 'Renewable_Storage']  #['Solar','solar', 'onwind', 'biomass', 'geothermal', 'ror', 'offwind-ac', 'hydro', 'offwind-dc', 'PHS', 'Renewable_Storage','Wind']
    solve_network(DE_1node, renewable_shares= [0.96,0.96,0.96,0.96,0.96], renewable_carriers = list_renewable_carriers)
